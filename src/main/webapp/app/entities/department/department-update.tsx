  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="attendanceApplicationApp.department.home.createOrEditLabel" data-cy="DepartmentCreateUpdateHeading">
            <Translate contentKey="attendanceApplicationApp.department.home.createOrEditLabel">Create or edit a Department</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('attendanceApplicationApp.department.code')}
                id="department-code"
                name="code"
                data-cy="code"
                type="text"
              />
              <ValidatedField
                label={translate('attendanceApplicationApp.department.nameEn')}
              ...
              />
              <ValidatedField
                label={translate('attendanceApplicationApp.department.nameAr')}
