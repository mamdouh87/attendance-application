    ...
    <Row>
      <Col md="8">
        <h2 data-cy="departmentDetailsHeading">
          <Translate contentKey="attendanceApplicationApp.department.detail.title">Department</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="code">
              <Translate contentKey="attendanceApplicationApp.department.code">Code</Translate>
            </span>
          </dt>
          <dd>{departmentEntity.code}</dd>
          <dt>
            <span id="nameEn">
              <Translate contentKey="attendanceApplicationApp.department.nameEn">Name En</Translate>
            </span>
          </dt>
          <dd>{departmentEntity.nameEn}</dd>
          <dt>
            <span id="nameAr">
              <Translate contentKey="attendanceApplicationApp.department.nameAr">Name Ar</Translate>
            </span>
          </dt>
