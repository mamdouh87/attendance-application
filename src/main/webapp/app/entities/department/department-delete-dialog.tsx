...
export const DepartmentDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="attendanceApplicationApp.department.delete.question">
        <Translate contentKey="attendanceApplicationApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
