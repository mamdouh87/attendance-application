    ...
    <Row>
      <Col md="8">
        <h2 data-cy="attendanceTypeDetailsHeading">
          <Translate contentKey="attendanceApplicationApp.attendanceType.detail.title">AttendanceType</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="code">
              <Translate contentKey="attendanceApplicationApp.attendanceType.code">Code</Translate>
            </span>
          </dt>
          <dd>{attendanceTypeEntity.code}</dd>
          <dt>
            <span id="descEn">
              <Translate contentKey="attendanceApplicationApp.attendanceType.descEn">Desc En</Translate>
            </span>
          </dt>
          <dd>{attendanceTypeEntity.descEn}</dd>
          <dt>
            <span id="descAr">
              <Translate contentKey="attendanceApplicationApp.attendanceType.descAr">Desc Ar</Translate>
            </span>
          </dt>
