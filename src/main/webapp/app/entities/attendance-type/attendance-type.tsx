  ...
  return (
    <div>
      <h2 id="attendance-type-heading" data-cy="AttendanceTypeHeading">
        <Translate contentKey="attendanceApplicationApp.attendanceType.home.title">Attendance Types</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="attendanceApplicationApp.attendanceType.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/attendance-type/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="attendanceApplicationApp.attendanceType.home.createLabel">Create new Attendance Type</Translate>
          </Link>
        </div>
      </h2>
        ...
        {attendanceTypeList && attendanceTypeList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="attendanceApplicationApp.attendanceType.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('code')}>
                  <Translate contentKey="attendanceApplicationApp.attendanceType.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('descEn')}>
                  <Translate contentKey="attendanceApplicationApp.attendanceType.descEn">Desc En</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('descAr')}>
                  <Translate contentKey="attendanceApplicationApp.attendanceType.descAr">Desc Ar</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="attendanceApplicationApp.attendanceType.home.notFound">No Attendance Types found</Translate>
            </div>
          )
        )}
      </div>
