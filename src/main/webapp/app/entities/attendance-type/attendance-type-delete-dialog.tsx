...
export const AttendanceTypeDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="attendanceApplicationApp.attendanceType.delete.question">
        <Translate contentKey="attendanceApplicationApp.attendanceType.delete.question" interpolate={{ id: attendanceTypeEntity.id }}>
