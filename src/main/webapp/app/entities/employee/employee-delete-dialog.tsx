...
export const EmployeeDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="attendanceApplicationApp.employee.delete.question">
        <Translate contentKey="attendanceApplicationApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
