...
export const AttendanceDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="attendanceApplicationApp.attendance.delete.question">
        <Translate contentKey="attendanceApplicationApp.attendance.delete.question" interpolate={{ id: attendanceEntity.id }}>
