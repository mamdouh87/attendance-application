    ...
    <Row>
      <Col md="8">
        <h2 data-cy="attendanceDetailsHeading">
          <Translate contentKey="attendanceApplicationApp.attendance.detail.title">Attendance</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="logDate">
              <Translate contentKey="attendanceApplicationApp.attendance.logDate">Log Date</Translate>
            </span>
          </dt>
          <dd>
            {attendanceEntity.logDate ? <TextFormat value={attendanceEntity.logDate} type="date" format={APP_LOCAL_DATE_FORMAT} /> : null}
          </dd>
          <dt>
            <span id="logTimeFrom">
          ...
          <dt>
            <span id="details">
              <Translate contentKey="attendanceApplicationApp.attendance.details">Details</Translate>
            </span>
          </dt>
          ...
          <dt>
            <Translate contentKey="attendanceApplicationApp.attendance.employee">Employee</Translate>
          </dt>
