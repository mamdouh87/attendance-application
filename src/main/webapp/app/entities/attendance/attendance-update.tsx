          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                label={translate('attendanceApplicationApp.attendance.attendanceType')}
                type="select"
              >
                <option value="" key="0" />
                {attendanceTypes
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('attendanceApplicationApp.attendance.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                label={translate('attendanceApplicationApp.attendance.managerApprovedBy')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                label={translate('attendanceApplicationApp.attendance.hrApprovedBy')}
                type="select"
              >
                <option value="" key="0" />
                {employees
